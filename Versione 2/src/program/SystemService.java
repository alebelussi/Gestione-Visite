...
public class SystemService {
	...
	private static final String MSG_INS_PSW = "Inserisci la password: ";
	...
	private static final String MSG_INS_PASSWORD = MSG_INS_PSW;
	...
	public static List<LocalDate> getAvailableDate(TimeSimulator time, DayOfWeek day, LocalDate startDate, LocalDate endDate, ArrayList<String> excludedDate, int plusMonths) {
	...
	//metodo che verifica che la data appartenga ad un tipo visita e viene usato per inserire le disponibilità del volontario
	...
	//metodo che aggiorna il volontario in visitTpye, coerenza dei dati
	public static void updateVolunteerInVisitType(VolunteerList volunteerList, VisitTypeList visitTypeList) {
		for(VisitType visitType : visitTypeList.getVisitTypeList().values()) {
	...
	private static void firstAccess(JsonManager jsonManager, Volunteer volunteer) {
		...
		do {
			password = InputDati.leggiStringaNonVuota(MSG_INS_PSW);
		}while(!InputDati.yesNo(MSG_CONFERMA_REGISTRAZIONE));
