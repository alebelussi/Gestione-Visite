...
public class DataConsistencyService {
	...
	public static void updateRegistrationState(Visit visit) {
		JsonManager jsRegistration = new JsonManager(FILE_ISCRIZIONI);
		...
		for(Registration registration : registrationList.getRegistrationList()) {
			if(registration.getVisit().getCounterId() == visit.getCounterId()) {
				...
				jsRegistration.modifyElement("code", registration.getCode(), registration);
			}
		}
	}
}
