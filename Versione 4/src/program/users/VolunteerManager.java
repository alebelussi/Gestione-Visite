	...
	public void add() {
		...
		do {
			...
			do {
				...
				//controllo che il nickname non coincida con nessun username del configuratore
				if(SystemService.existConfigurator(finalNickname))
					System.out.println(MSG_ERR_NICK_CONF);
				//controllo che il nickname non coincida con nessun username del fruitore
				else if(SystemService.existUser(finalNickname))
