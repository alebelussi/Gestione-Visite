...
public class VisitTypeList {
	...
	public VisitTypeList(RepositorySystem repositoryVisitType) {
	...
	private void loadVisitType() {
		List<VisitType> list = repositoryVisitType.loadData(VisitType.class);
	...
	public void addVisitType(VisitType visitType) {
		...
		this.repositoryVisitType.addElement(VisitType.class, visitType);
	}
	...
	public void modifyVisitType(VisitType visitType) {
		this.visitTypeList.put(visitType.getTitle(), visitType);
		this.repositoryVisitType.modifyElement("title", visitType.getTitle(), visitType);
	}
	...
	public VisitType searchVisitType(String key) {
		return this.repositoryVisitType.searchElement(VisitType.class,"title", key);
	}

	public void removeVisitType(VisitType visitType) {
		this.repositoryVisitType.removeElement(VisitType.class, visitType);
	...
	//metodo per restituire il valore degli elementi della mappa
	public Collection <VisitType> getAllVisitTypes() {
	    return visitTypeList.values(); 
	}
}
